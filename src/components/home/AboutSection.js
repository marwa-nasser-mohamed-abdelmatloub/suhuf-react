...
const AboutSection = () => {
  ...
  return (
    <section
      className="py-5"
      style={{ direction: "rtl", backgroundColor: theme.secondary }}
    >
        ...
        <div className="row align-items-center g-5">
          <div className="col-lg-6 text-center text-lg-end">
            ...
            <p className="text-muted mb-3">
              نحن نقدم تعليم القرآن الكريم عن بُعد مع نخبة من المعلمين والمعلمات
              المؤهلين. يمكنك تعلم التلاوة، التجويد، التفسير، والترجمة بسهولة من
              منزلك.
            </p>
            <p className="text-muted mb-4">
              نسعى لتوفير بيئة تعليمية تفاعلية وآمنة لجميع الأعمار مع دعم متواصل
              للطلاب والتقييمات الدورية لضمان أفضل النتائج.
            </p>
          ...
          <div className="col-lg-6 position-relative d-flex justify-content-center align-items-center images-wrapper">
            ...
            >
              ...
              ></span>
              <i
                className="bi bi-play-fill position-relative"
                style={{ zIndex: 2 }}
              ></i>
            </button>
          </div>
      ...
      {showVideo && (
        ...
        >
          <div
            className="ratio ratio-16x9 w-75"
